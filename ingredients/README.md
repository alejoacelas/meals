...
- `shopping-list.md` — a week's shop for two, built from the proven ingredients.

Promotion candidate → proven is manual, one category at a time.

## How ranking works
Each candidate table is ranked best-first, columns in the order I scan them:

| Ingredient | Why here | Versatility | Prep effort | Availability | Nutrition |

- **Why here** — one sentence on the placement.
- **Versatility** — how many recipes it earns its place in.
- **Prep effort** — active time and washing it adds.
