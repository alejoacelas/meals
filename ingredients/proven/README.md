...
role I've confirmed has its own file with the reasoning; the rest are the
workflow's recommendation, still pending my review of `../candidates/`.
...
- I promote what I've settled on into here by hand, with a note on why. Nothing is
  promoted automatically — same rule as recipes.
